...
from liverse import models
from liverse.agents import exploration as expl
...
class Dreamer(nn.Module):
    def __init__(self, obs_space, act_space, config, logger, dataset, target_text_embedding):
        ...
        if (
            config.compile and __import__('os').name != "nt"
        ):
