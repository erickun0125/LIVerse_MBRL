...
Additionally, although the robot was unable to fully press and insert the button, we  found that MPC that uses AI-generated image instead of real rendered image was still able to touch the button. As a result, by simply changing the goal image, the agent was able to partially succeed in adapting to new tasks within zero-shot manner. 
\begin{figure}[htbp]
    \centering
    \begin{minipage}[b]{0.48\linewidth}
        \centering
